...
@section('menu-data')
<input type="hidden" name="" class="menu-data" value="permission-group | permission">
@endsection()
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="align-justify-center">
                    <a href="#" class="btn btn-default btn-sm flex-right modal-side-control" atr="Create">Phân quyền<i class="fas fa-plus m-l-5"></i></a> 
                </div>
            </div>
        </div>
        <div class="m-t-25">
...
@section('js')
    ...
    <script src="{{ asset('manager/assets/js/page/permission.js') }}"></script>
